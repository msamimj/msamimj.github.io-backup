...
.to (c14,           0.33,    {top: 100*ratio, left: 100*ratio, width: 340*ratio, height: 225*ratio},    "-=0.15")
.to (c7,            0.33,    {top: 40*ratio, width: 580*ratio, left:0*ratio, height:10*ratio},          "-=0.15")
.to (c24,           0.33,    {height: 35*ratio, width: 570*ratio, left: 10*ratio, bottom: 0}                    )
.to (c8,            0.33,    {width: 10*ratio, height: 360*ratio, top:40*ratio},                        "-=0.15")
.to (c12,           0.33,    {width: 7*ratio, height: 100*ratio, top: 80*ratio, left: 580*ratio}                )
.to (c13,           0.33,    {width: 13*ratio, height: 70*ratio, top: 95*ratio, left: 587*ratio},       "-=0.15")
.to (c16,           0.33,    {top: 140*ratio, left:100*ratio, width: 340*ratio, height: 160*ratio},     "-=0.15")
.to (c9,            0.33,    {width: 5*ratio, top: 50*ratio, height: 350*ratio, left: 75*ratio}                 )
.to (c10,           0.33,    {width: 5*ratio, top: 50*ratio, height: 350*ratio, left:460*ratio},        "-=0.15")
.to (c11,           0.33,    {width: 35*ratio, height: 350*ratio, top: 50*ratio, left:545*ratio}                )
.to (c15,           0.33,    {top: 100*ratio, left: 485*ratio, width: 65*ratio, height: 225*ratio},     "-=0.15")
.to (c17,           0.33,    {top: 160*ratio, left: 120*ratio, width: 300*ratio, height: 120*ratio}             )
.to (c20,           0.33,    {top: 195*ratio, left: 220*ratio, width: 60*ratio, height: 50*ratio},      "-=0.15")
.to (c21,           0.33,    {left: 280*ratio, top: 195*ratio, width: 40*ratio, height: 50*ratio}               )
.to (c6,            0.33,    {width: 450*ratio, height:10*ratio, top: 30*ratio, left:75*ratio},         "-=0.15")
.to (c1,            0.33,    {width: 72*ratio, height: 20*ratio, top: 10*ratio, left:100*ratio}                 )
.to (c2,            0.33,    {width: 72*ratio, height: 20*ratio, top: 10*ratio, left:182*ratio},        "-=0.33")
.to (c3,            0.33,    {width: 72*ratio, height: 20*ratio, top: 10*ratio, left:264*ratio},        "-=0.33")
.to (c4,            0.33,    {width: 72*ratio, height: 20*ratio, top: 10*ratio, left:346*ratio},        "-=0.33")
.to (c5,            0.33,    {width: 72*ratio, height: 20*ratio, top: 10*ratio, left:428*ratio},        "-=0.33")
.to (c18,           0.33,    {top: 205*ratio, left: 150*ratio, width: 50*ratio, height: 30*ratio}               )
.to (c19,           0.33,    {top: 195*ratio, left: 160*ratio, width: 30*ratio, height: 50*ratio},      "-=0.15")
.to (c22,           0.33,    {left: 340*ratio, top: 205*ratio, width: 50*ratio, height: 30*ratio},      "-=0.15")
.to (c23,           0.33,    {left: 350*ratio, top: 195*ratio, width: 30*ratio, height: 50*ratio},      "-=0.15")
