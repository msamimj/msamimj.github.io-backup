window.onload = function(){
    ...
    var tl = new TimelineMax({delay:0.1, onComplete: unhidePage2});
    ...
    .to (inc,           0,      {width: 400*ratio, left: (vwidth/2)-(200*ratio), top: vheight-(80*ratio)})
    ...
    .to (down,          0,      {top: vheight-80, left: 30})
    .to (down,          .2,     {opacity: 100, scale: 1.2})
    .to (down,          .3,     {top: "+=12", repeat: 3, yoyo: true})
    ...
    var scrollToPage2 = function(){
        des = document.getElementById('page2').offsetTop;
